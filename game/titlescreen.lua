...
local buttons = {
   Button:new(images.buttonimg, LOVE.graphics.newQuad(0, 0, 136, 40, 136, 80), LOVE.graphics.newQuad(0, 40, 136, 40, 136, 80), nil, button_x, button_y + 50, 136, 40, function() print("PLAY") end, "PLAY", {0.73, 0.6, 0.38, 1}, 16),
